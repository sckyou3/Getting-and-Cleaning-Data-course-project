...
download.file(url, destfile = "./data/uci.zip", mode="wb")
...
##01 Merge the training and the test sets to create one data set
humanActivity <- rbind(
...
##05 Create a second, independent tidy set with the average of each variable for each activity and each subject
